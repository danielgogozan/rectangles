...
/*
we iterate the shortest set and count any point from it that is also in the other set in order to determine
the length of the intersection set
*/
...
based on the length of the intersection set, how many rectangles (that are parallel with the X, Y axis)
